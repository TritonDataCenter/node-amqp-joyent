...
- [node-amqp-joyent](#node-amqp-joyent)
  ...
  - [Queue](#queue)
    - [connection.queue(name, options)](#connectionqueuename-options)
    ...
    - [queue.bind([exchange,] routing[, callback])](#queuebindexchange-routing-callback)
    ...
    - [queue.unbind_headers([exchange,] routing)](#queueunbind_headersexchange-routing)
